...
struct bcm2708_mci_host {
	...
	unsigned char		current_bus_width;
	unsigned char		current_timing;
	unsigned int		current_clock_hz;
	unsigned short		current_clkdiv;
};

static inline char *bcm2708_mci_kmap_atomic(struct scatterlist *sg,
	unsigned long *flags)
{
